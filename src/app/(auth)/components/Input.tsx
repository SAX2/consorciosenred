    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="flex w-full rounded-md bg-black-sec items-center">
        <input
          {...props}
          className={cn(
            "w-full p-2 px-3 rounded-md placeholder:text-grey-text text-black outline-none border border-outline dark:text-white dark:border-outline-dark", props.className
          )}
        />
