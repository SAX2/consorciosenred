        ...
        <div className="flex flex-col gap-8 flex-1 justify-center">
          <div className="flex flex-col gap-6">
            <h1 className="leading-none text-5xl font-bold font-geist tracking-tight text-black">
              {appInstallPropietario.title}
            </h1>
            <p className="text-xl font-medium text-black/75">
              {appInstallPropietario.description}
            </p>
          </div>
          <div className="flex gap-3">
            {appInstallPropietario.links.map((link, index) => {
              return (
        ...
        <div className="flex-1  flex items-center">
          ...
          >
            <Image
              width={291}
              height={604}
              src={appInstallPropietario.Image}
              alt={appInstallPropietario.title}
